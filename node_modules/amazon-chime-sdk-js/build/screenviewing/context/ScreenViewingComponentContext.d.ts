...
export interface ScreenViewingComponentProviders {
    ...
    jpegDecoderControllerProvider?: (jpegDecoderController: DefaultJPEGDecoderController) => DefaultJPEGDecoderController;
    messageDispatcherProvider?: (messageDispatcher: ScreenViewingSessionObserver) => ScreenViewingSessionObserver;
    messageHandlerProvider?: (messageHandler: ScreenViewingMessageHandler) => ScreenViewingMessageHandler;
