...
export default class RealtimeState {
     ...
     */
    attendeeIdChangesCallbacks: ((attendeeId: string, present: boolean, externalUserId?: string) => void)[];
    /**
    ...
    volumeIndicatorState: {
        [key: string]: RealtimeVolumeIndicator;
    };
    /**
    ...
    volumeIndicatorCallbacks: {
        [key: string]: ((attendeeId: string, volume: number | null, muted: boolean | null, signalStrength: number | null, externalUserId?: string) => void)[];
    };
    /**
     ...
     */
    sendDataMessageCallbacks: ((topic: string, // eslint-disable-next-line @typescript-eslint/no-explicit-any
