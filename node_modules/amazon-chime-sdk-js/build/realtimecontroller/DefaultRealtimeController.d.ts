...
export default class DefaultRealtimeController implements RealtimeController {
    ...
    realtimeSetAttendeeIdPresence(attendeeId: string, present: boolean, externalUserId: string | null): void;
    realtimeSubscribeToAttendeeIdPresence(callback: (attendeeId: string, present: boolean, externalUserId?: string) => void): void;
    realtimeUnsubscribeToAttendeeIdPresence(callback: (attendeeId: string, present: boolean, externalUserId?: string) => void): void;
